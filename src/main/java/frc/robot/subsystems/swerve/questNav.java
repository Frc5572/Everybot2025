...
public class questNav implements questNavIO {
    ...
    public void updateInputs(QuestNavInputs inputs) {
        inputs.questQuaternion = getQuaternion();
        inputs.questBattery = getBatteryPercent();
        inputs.questPose = getPose();
        inputs.questConnected = connected();
        inputs.questYaw = getOculusYaw();
    }
}
